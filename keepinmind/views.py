...
def home(request):
    ...
    return render(request,'keepinmind/home.html', {'notes': user_notes,'all_notes':all_notes, 'app':'keepinmind', 'appname':'Keep in mind !'})
...
def edit_note(request, id):
    ...
    if request.method == "POST":
        ...
        if request.POST.get('question') is not None :
            ...
            note.save()
            return redirect('keepinmind_home')
    return render(request, "keepinmind/new_note_form.html", {'note':note,'note_id':id})
